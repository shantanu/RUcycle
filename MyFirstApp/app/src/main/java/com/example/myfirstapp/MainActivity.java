...
public class MainActivity extends AppCompatActivity {
    public static final String EXTRA_MESSAGE = "com.example.myfirstapp.TORECYCLE";
    ...
    protected void takePicture() {
        Log.v("Tag1", "Pressed Take Picture!");
            ...
            ImageReader.OnImageAvailableListener readerListener = new ImageReader.OnImageAvailableListener() {
                ...
                public void onImageAvailable(ImageReader reader) {
                    ...
                    try {
                        ...
                        Toast.makeText(MainActivity.this, "Took Picture!", Toast.LENGTH_SHORT).show();
    ...
    private void openRecycleActivity(String torecycle) {
        Log.v("Tag3", "Open Recycle");

        Intent intent = new Intent(this, RecycleActivity.class);
        intent.putExtra(EXTRA_MESSAGE, torecycle);
        startActivity(intent);
    }
    private void openTrashActivity(String torecycle) {
        Log.v("Tag3", "Open Trash");
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    jsonParam.put("img", base64);

                    Log.i("TAGJSON", jsonParam.toString());
                    ...
                    Log.i("TAGSTATUS", String.valueOf(conn.getResponseCode()));
                    Log.i("TAGMSG" , conn.getResponseMessage());
